...
fn setup_proposal(threshold: u32, motion_type: MotionType) -> Proposal {
    ...
    let motion = match motion_type {
        MotionType::SimpleMajority => RuntimeCall::Motion(pallet_motion::Call::simple_majority {
            call: Box::new(inner_call),
        }),
        MotionType::SuperMajority => RuntimeCall::Motion(pallet_motion::Call::super_majority {
            call: Box::new(inner_call),
        }),
        MotionType::Unanimous => RuntimeCall::Motion(pallet_motion::Call::unanimous {
            call: Box::new(inner_call),
        }),
    };
    ...
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(
            ...
            vec![
                ...
                record(RuntimeEvent::Council(CollectiveEvent::Approved {
                    proposal_hash: hash
                })),
